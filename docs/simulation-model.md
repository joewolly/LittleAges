# Little Ages M0-M3 Simulation Model

This is the exact deterministic model implemented by M0 through M3. M1 adds immutable deterministic geography/resource definitions, M2 adds founders and movement, and M3 adds the survival loop over mutable resource quantities, stockpile, needs, gathering, health, and mortality.
...
SimulationRulesVersion:   m3-rng1-survival1
Previous rules version:   m2-rng1-citizen1
SurvivalVersion:           1
...
Settlement structures/shelters are M4; social/family/aging systems are M5; historical gameplay facts and queries are M6; server hardening/deployment is M7; and headless/MAX, scale, profiling, and 100-year validation are M8. M3 survival is implemented and documented below.
