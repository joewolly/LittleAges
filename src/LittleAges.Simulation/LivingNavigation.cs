...
public sealed partial class SimulationEngine
{
    ...
    private ResourceNode? SelectLivingResourceTarget(ResourceType type, IReadOnlyDictionary<TileCoordinate, long> costs)
    {
        ...
        foreach (var node in nodes)
        {
            ...
            if (quantity <= 0 || !costs.TryGetValue(node.Coordinate, out var cost)) continue;
