...
public sealed record SimulationPersistenceSnapshot
{
    ...
    public SimulationPersistenceSnapshot(WorldSeed seed, WorldMinute worldMinute, string worldSchemaVersion, string simulationRulesVersion, string applicationVersion, string worldConfiguration, DeterministicCountersSnapshot counters, IReadOnlyList<ScheduledEventSnapshot> scheduledEvents, WorldMap? world, IReadOnlyList<Citizen>? citizens, int citizenGenerationVersion = 0, IReadOnlyList<ResourceState>? resourceStates = null, SettlementState? settlement = null, int survivalVersion = 0, int settlementVersion = 0, IReadOnlyList<Structure>? structures = null, IReadOnlyList<StructureContribution>? structureContributions = null, int socialVersion = 0, IReadOnlyList<RelationshipState>? relationships = null, IReadOnlyList<Household>? households = null, int historyVersion = 0, HistoryState? historyState = null, IReadOnlyList<HistoricalEvent>? historicalEvents = null, IReadOnlyList<HistoricalEventCitizenLink>? historicalEventCitizens = null, IReadOnlyList<HistoricalEventStructureLink>? historicalEventStructures = null, IReadOnlyList<StatisticsSample>? statisticsSamples = null, IReadOnlyList<CitizenMemory>? memories = null, AgricultureState? agriculture = null)
    {
        ...
        var m5 = simulationRulesVersion is SimulationEngine.M5SimulationRulesVersion or SimulationEngine.M6SimulationRulesVersion or SimulationEngine.M8SimulationRulesVersion or SimulationEngine.GrowthSimulationRulesVersion or SimulationEngine.AgricultureSimulationRulesVersion;
        var m6 = simulationRulesVersion is SimulationEngine.M6SimulationRulesVersion or SimulationEngine.M8SimulationRulesVersion or SimulationEngine.GrowthSimulationRulesVersion or SimulationEngine.AgricultureSimulationRulesVersion;
...
public sealed partial class SimulationEngine
{
    ...
    public static bool SocialSystemsEnabled(string rulesVersion) => rulesVersion is M5SimulationRulesVersion or M6SimulationRulesVersion or M8SimulationRulesVersion or GrowthSimulationRulesVersion or AgricultureSimulationRulesVersion;
    public static bool HistorySystemsEnabled(string rulesVersion) => rulesVersion is M6SimulationRulesVersion or M8SimulationRulesVersion or GrowthSimulationRulesVersion or AgricultureSimulationRulesVersion;
    ...
    public static int FoodShortageRecoveryMultiplier(string rulesVersion) => rulesVersion switch
    {
        ...
        M8SimulationRulesVersion or GrowthSimulationRulesVersion or AgricultureSimulationRulesVersion => 20,
    ...
    public string ComputeSurvivalFingerprint()
    {
        ...
        var survival = SimulationRulesVersion is M5SimulationRulesVersion or M6SimulationRulesVersion or M8SimulationRulesVersion or GrowthSimulationRulesVersion or AgricultureSimulationRulesVersion or M4SimulationRulesVersion or M3SimulationRulesVersion ? SurvivalVersion : 0;
    ...
    private static int ActionTieRank(CitizenAction action, bool m4Candidates) => m4Candidates ? action switch { CitizenAction.Eat => 0, CitizenAction.Rest => 1, CitizenAction.GatherFood => 2, CitizenAction.Socialize => 3, CitizenAction.HaulConstruction => 4, CitizenAction.Build => 5, CitizenAction.GatherWood => 6, CitizenAction.GatherStone => 7, CitizenAction.Explore => 8, CitizenAction.Wander => 9, CitizenAction.Idle => 10, CitizenAction.WorkFarm => 11, CitizenAction.HaulHarvest => 12, _ => throw new ArgumentOutOfRangeException(nameof(action), action, "Only decision actions have a tie rank.") } : action switch { CitizenAction.Eat => 0, CitizenAction.Rest => 1, CitizenAction.GatherFood => 2, CitizenAction.Socialize => 3, CitizenAction.GatherWood => 4, CitizenAction.GatherStone => 5, CitizenAction.Explore => 6, CitizenAction.Wander => 7, CitizenAction.Idle => 8, CitizenAction.WorkFarm => 11, CitizenAction.HaulHarvest => 12, _ => throw new ArgumentOutOfRangeException(nameof(action), action, "Only decision actions have a tie rank.") };
