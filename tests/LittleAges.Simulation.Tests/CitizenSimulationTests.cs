...
public sealed class CitizenSimulationTests
{
    ...
    {
        var engine = new SimulationEngine(new WorldSeed(seed), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
        var citizens = engine.Citizens;
        Assert.Equal(20, citizens.Count);
        Assert.Equal(Enumerable.Range(0, 20), citizens.Select(c => c.FounderOrdinal!.Value));
    ...
    public void FounderFingerprintIsCultureInvariantWithNegativeBirthMinutes()
    {
        ...
        try
        {
            ...
            var invariant = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
            ...
            var customized = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
    ...
    {
        var first = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
        var second = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
    ...
    public void PayloadRoundTripsAndReadSnapshotsDoNotExposeMutableState()
    {
        ...
        var engine = new SimulationEngine(new WorldSeed(1), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
    ...
    public void PersistenceAndTimeChunksPreserveCitizenState()
    {
        ...
        var chunked = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
    ...
    {
        var unobserved = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
        var observed = new SimulationEngine(new WorldSeed(42), simulationRulesVersion: SimulationEngine.M2SimulationRulesVersion);
        ...
        params (TileCoordinate Coordinate, TerrainType Terrain)[] routeTiles)
    {
        ...
        var snapshot = new SimulationPersistenceSnapshot(
            ...
            SimulationEngine.M2SimulationRulesVersion,
            "test",
